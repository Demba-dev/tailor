...
from .views import catalogue_list, catalogue_detail, catalogue_import, catalogue_create, catalogue_update, add_to_favorites
...
urlpatterns = [
    ...
    path('<int:pk>/update/', catalogue_update, name='catalogue_update'),
